...
parser.add_argument("-input", help='Txt file with the information on the tag combination and freq of each unique seq')
parser.add_argument("-outFas",help='Output fasta wuth the unique sequences being repeated as many times as their reported freq')
