...
parser.add_argument("-psInfo", help='Txt file with the information on the tag combination in each PCR reaction for every sample [Format: sampleName\tTagNameForwardFromPCR1\tTagNameReverseFromPCR1\tPool#\nsampleName\tTagNameForwardFromPCR2\tTagNameReverseFromPCR2\tPool#\n...]')
parser.add_argument("-x",type=int, help='Number of PCR rxns performed per sample')
